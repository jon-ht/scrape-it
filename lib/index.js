            ...
            iterateObj(data, (cOpt, optName) => {
                ...
                if (cOpt.listItem) {
                    ...
                    for (let i = 0; i < $items.length; ++i) {
                        ...
                        cOpt.convert = proxyConvert((cDoc.___raw || cDoc), (cOpt.convert || function(x) { return x }))

                        docs.push(cOpt.convert)
                    }
                } else {
                    ...
                    if (cOpt.convert) {
                        cOpt.convert = proxyConvert((value, $elm), cOpt.convert)
                        value = cOpt.convert
                    }
